...
// Called every frame
void APMTest::Tick(float DeltaTime)
{
...
//my functions
void APMTest::AddTriangle(int32 V1, int32 V2, int32 V3)
{
	Triangles.Add(V1);
	Triangles.Add(V2);
	Triangles.Add(V3);
...
void APMTest::GenerateCubeMesh()
{
	...
	Vertices.Add(FVector(wallWidth, -100, 0)); //lower front left - 4
	Vertices.Add(FVector(wallWidth, -100, 100)); //upper front left - 5

	Vertices.Add(FVector(10, 100, 100)); //upper front right - 6
	Vertices.Add(FVector(10, 100, 0)); //lower front right - 7
